...
oee_crawled = glue_context.create_dynamic_frame.from_catalog(
    ...
    table_name="crawled_oee_vrewwqazvrfzrigag63c7doeqy_int",
)

defective_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="integration",
    table_name="crawled_defective_vrewwqazvrfzrigag63c7doeqy_int",
)

part_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="integration",
    table_name="crawled_part_vrewwqazvrfzrigag63c7doeqy_int",
)

disruption_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="integration",
    table_name="crawled_disruption_vrewwqazvrfzrigag63c7doeqy_int",
)

unit_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="integration",
    table_name="crawled_unit_vrewwqazvrfzrigag63c7doeqy_int",
)

actualcount_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="integration",
    table_name="crawled_actualcount_vrewwqazvrfzrigag63c7doeqy_int",
)

cyclestation_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="integration",
    table_name="crawled_cyclestation_vrewwqazvrfzrigag63c7doeqy_int",
)

team_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="integration",
    table_name="crawled_team_vrewwqazvrfzrigag63c7doeqy_int",
)
...
actualcount_unit_defective_join.write.mode("overwrite").format("parquet").save(
    "s3://iprocess-integration-glue/glue/actualcount/"
)
disruption_unit_team_originator_part_cyclestation_join.write.mode("overwrite").format("parquet").save(
    "s3://iprocess-integration-glue/glue/disruption/"
)
oee_unit_join.write.mode("overwrite").format("parquet").save("s3://iprocess-integration-glue/glue/oee/")
unit.write.mode("overwrite").format("parquet").save("s3://iprocess-integration-glue/glue/unit/")
