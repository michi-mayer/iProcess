...
oee_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="dev",
    table_name="crawled_oee_2bhuxjwdvjh5ddqyyzpfmuusii_develop",
)

defective_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="dev",
    table_name="crawled_defective_2bhuxjwdvjh5ddqyyzpfmuusii_develop",
)

part_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="dev",
    table_name="crawled_part_2bhuxjwdvjh5ddqyyzpfmuusii_develop",
)

disruption_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="dev",
    table_name="crawled_disruption_2bhuxjwdvjh5ddqyyzpfmuusii_develop",
)

unit_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="dev",
    table_name="crawled_unit_2bhuxjwdvjh5ddqyyzpfmuusii_develop",
)

actualcount_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="dev",
    table_name="crawled_actualcount_2bhuxjwdvjh5ddqyyzpfmuusii_develop",
)

cyclestation_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="dev",
    table_name="crawled_cyclestation_2bhuxjwdvjh5ddqyyzpfmuusii_develop",
)

team_crawled = glue_context.create_dynamic_frame.from_catalog(
    database="dev",
    table_name="crawled_team_2bhuxjwdvjh5ddqyyzpfmuusii_develop",
)
...
defective_unit_join.write.mode("overwrite").format("parquet").save(
    "s3://devglue/glue/defective/"
)
actualcount_unit_defective_join.write.mode("overwrite").format("parquet").save(
    "s3://devglue/glue/actualcount/"
)
disruption_unit_team_originator_part_cyclestation_join.write.mode("overwrite").format("parquet").save(
    "s3://devglue/glue/disruption/"
)
oee_unit_join.write.mode("overwrite").format("parquet").save("s3://devglue/glue/oee/")
unit.write.mode("overwrite").format("parquet").save("s3://devglue/glue/unit/")
