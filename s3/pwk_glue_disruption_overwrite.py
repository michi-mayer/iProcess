...
DataSource0 = glueContext.create_dynamic_frame.from_catalog(
    database="disruptions_view", table_name="pwk_crawled_disruption_675orbcw3bg5xovk7fvhcdicja_masterpwk", transformation_ctx="DataSource0")
# @type: DropFields
...
df.write.mode('overwrite').json(
    's3://s3-vw-poc-quicksight/pwk_glued_disruption/')
job.commit()
